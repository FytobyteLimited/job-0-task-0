...
const Contact = () => {
  return (
    <div>
      ...
      <p className="text-sm text-[#A3A3A3] my-12 text-center">
        Drop us a line to start your project or simply just say
        &quot;Hello!&quot;
      </p>
      ...
      <div className="flex flex-col  lg:flex-row gap-8 justify-between">
        ...
        <div className="w-full lg:w-5/12  flex  flex-col justify-between">
          ...
          <p className="text-[#737373] text-sm my-1">
            Phone: (+62) 82260362579
          </p>
        ...
        <div className="flex flex-col  gap-3 w-full lg:w-5/12">
          ...
          <textarea
            ...
            className="appearance-none block w-full px-3 py-2 rounded-md focus:outline-none focus:border-gray-300 border border-gray-200 bg-gray-100 text-gray-700 leading-tight"
          />
          <button className="py-2 w-full bg-black text-white">
            Send The Message
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-8">
        {/* text-card */}
        <div className="w-full lg:w-1/2 bg-black  h-60 flex justify-center items-center rounded-xl">
        ...
        <div className="w-full lg:w-1/2  h-60 rounded-xl">
          <Image
            className="bg-cover w-full h-60 rounded-xl"
            src={contactImg}
            alt="contact image"
            height={500}
            width={500}
